<template>
  <section id="cardlist" class="section">
    <div class="level">
...
import cardModal from './feedbackCard.modal';
...
#cardlist .level:first-child {
  border-bottom: 1px solid #cecece;
}

#cardlist .level-right .level-item a {
  padding-bottom: -4px;
}

#cardlist .level-right .level-item a.is-active {

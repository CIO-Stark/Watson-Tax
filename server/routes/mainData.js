(function () {
    ...
    module.exports = function (app, modules) {
                            ...
                            element.entities.forEach(entity => {
                                ...
                                if(!entities[entity.entity])
                                    entities[entity.entity] = {
                                        words:[element.input.text.substring(entity.location[0], entity.location[1])],
                                    ...
                                    if(entities[entity.entity].words.indexOf(word) == -1)
                                        entities[entity.entity].words.push(word);
                                }
                            });
        ...
        app.post("/parsedData/:size", validateToken, (req, res) => {
            ...
            let url = modules.appEnv.url + '/crawlerData/' + req.params.size;
